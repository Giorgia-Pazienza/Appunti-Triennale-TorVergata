...
2. ??? Shortest interval, considera i job in ordine crescente di fj – sj. 
FAI ESEMPIO
...
Se scelgo un $$job_k+1$$ che è compatibile con la soluzione ottima. 
Questo $$job_k+1$$ sarà compatibile pure con la soluzione greedy poichè il lemma ci dice che il greedy prende il più piccolo. Questo porterà ad affermare che $$m < k$$ il che è ASSURDO. 
